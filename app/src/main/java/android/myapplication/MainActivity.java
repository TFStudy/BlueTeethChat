...
public class MainActivity extends AppCompatActivity {
    ...
    private void setupChat(){
        ...
        ListView mConversationView = findViewById(R.id.list_conversation);
        ...
        switch (requestCode){
            case REQUEST_CONNECT_DEVICE:
                if(resultCode==Activity.RESULT_OK){
                    String address= Objects.requireNonNull(data.getExtras()).getString(DeviceList.EXTRA_DEVICE_ADDRESS);
